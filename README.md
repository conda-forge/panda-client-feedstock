...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/panda-client-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/panda-client-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add panda-client
# for installing globally
pixi global install panda-client
```
...
It is possible to list all of the versions of `panda-client` available on your platform:
...
```
pixi search panda-client --channel conda-forge
```
