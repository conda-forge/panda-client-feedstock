...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/panda-client-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13455&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/panda-client-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `panda-client` can be installed with:

```
conda install panda-client
```

It is possible to list all of the versions of `panda-client` available on your platform with:
